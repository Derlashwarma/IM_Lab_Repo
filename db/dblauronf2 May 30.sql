...
--
-- Host: 127.0.0.1
-- Generation Time: May 30, 2024 at 04:01 AM
...
(55, 10, 'images/ferarrileclerc.jpg', 'My favorite F1 car', 4, 0, 1),
(56, 11, 'images/firstFerrari.jpg', 'My first ferrari', 4, 0, 1),
(57, 11, 'images/fastCar.jpg', 'Planning of selling my first w12, may the highest bidder win ', 0, 1, 1),
(58, 12, 'images/bmwfast.jpg', 'My favorite European baby ', 2, 0, 1);
...
(33, 'LauronTioco@gmail.com', 'Tioco', '$2y$10$IR.yCOc1f0W1n4s75YYLA.t7ewFOaZ.wowiGmdIYps1X1ZZ4kDpjq', 0, 1, 1);
...
--
ALTER TABLE `tbluseraccount`
  MODIFY `acctid` int(5) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=34;
